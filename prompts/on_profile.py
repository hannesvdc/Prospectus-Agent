...
def build_user(url: str) -> str:
    return (
        ...
        "page if linked — don't crawl). Summarise, in under 120 words, what Open "
        "Numerics does: its core services, the technical methods it uses, and the "
        "kinds of problems and industries it serves. Write it as a tight brief "
        "another writer could use to explain ON to a prospect."
    )
